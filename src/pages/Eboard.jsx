...
const eboardMembers = [
  ...
  },
  {
    ...
    year: '3rd Year',
    internship: 'Market Quality Exterior Co-op @ Honda',
  ...
  },
  {
    ...
    year: '3rd Year',
    internship: 'Supply Chain Management Intern @ Bechtel',
  ...
  },
  {
    ...
    year: '3rd Year',
    internship: 'Research Assistant @ OSU',
  ...
  },
  {
    ...
    year: '3rd Year',
    internship: 'Environmental Engineer Intern @ GM',
  ...
  },
  {
    ...
    year: '3rd Year',
    internship: 'Product Development Co-op @ Parker Hannifin',
  ...
  },
  {
    ...
    year: '3rd Year',
    internship: 'Software Engineer Intern @ JPMorganChase',
  ...
  },
  {
    ...
    major: 'Computer Science & Engineering',
    year: '2nd Year',
    internship: 'Undergraduate Researcher @ RED Lab OSU',
  ...
  },
  {
    ...
    year: '3rd Year',
    internship: 'Process Development Engineer Intern @ Lubrizol',
...
function LoteriaCard({ member }) {
  ...
  return (
    <div
      className={`loteria-card flex flex-col aspect-[2.5/3.5] bg-surface-container-lowest p-4 rounded-xl shadow-lg border-4 relative w-[calc(50%-12px)] sm:w-[calc(33.333%-16px)] md:w-[calc(25%-18px)] xl:w-[calc(20%-19.2px)] ${accentColor} ${member.rotate}`}
    >

      {/* Photo slot */}
      <div className="w-full rounded-lg overflow-hidden mb-4 bg-surface-container-high" style={{ aspectRatio: '1 / 1.2' }}>
        {member.photo ? (
          <img
            src={member.photo}
      ...
      {/* Icon sticker */}
      <div className={`absolute -bottom-2 -right-2 ${member.iconBg} w-10 h-10 flex items-center justify-center rounded-full shadow-md aspect-square`}>
        <span
