        ...
        <div className="max-w-screen-2xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center z-10">
          ...
          <div className="relative h-[500px] lg:h-[600px] collage-container hidden lg:block">
            ...
            <div className="absolute top-0 right-4 w-48 h-48 rounded-lg overflow-hidden shadow-xl z-30 sticker-rotate-neg border-8 border-surface-container-lowest">
              {/*
               * 📸 SWAP PHOTO: Replace <ImagePlaceholder> with:
               * <img src="/photos/lab-activity.jpg" alt="Lab activity" className="w-full h-full object-cover" />
               */}
              <ImagePlaceholder label="Lab Activity Photo" className="w-full h-full" />
            </div>
            {/* Rocket icon sticker */}
            <div className="absolute bottom-4 left-4 bg-primary-container p-8 rounded-full z-30 shadow-lg sticker-rotate-pos">
              <span
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-secondary-container p-8 rounded-lg md:col-span-2 flex flex-col md:flex-row-reverse gap-8 items-center text-on-secondary-container group">
              ...
              <div className="w-full md:w-64 h-48 rounded-xl overflow-hidden sticker-rotate-neg">
                {/*
                 * 📸 SWAP PHOTO: Replace <ImagePlaceholder> with:
                 * <img src="/photos/leadership.jpg" alt="Leadership workshop" className="w-full h-full object-cover" />
                 */}
                <ImagePlaceholder label="Leadership Workshop Photo" className="w-full h-full" />
              </div>
            </div>
